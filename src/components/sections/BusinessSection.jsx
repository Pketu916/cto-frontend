    ...
    <section>
      ...
      <div className="text-center max-w-2xl mx-auto mb-12">
        <h2 className="text-2xl md:text-4xl font-bold relative inline-block">
          Transform Your Care Experience with
        ...
        <p className="text-lg text-gray-600 mt-4 max-w-3xl mx-auto">
          Discover comprehensive care solutions designed to support NDIS
          participants, My Aged Care recipients, and families with innovative
